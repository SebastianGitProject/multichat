...
class MainActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        createAndWriteToFile(applicationContext, percorsoDeiFile)
        ReadTxt(applicationContext, percorsoDeiFile)
        ...
        btnSubmit.setOnClickListener {
            ...
            if(rispostaUtente == null || rispostaUtente == ""){
                ...
                writeTxt(applicationContext, percorsoDeiFile)
            ...
            if(rispostagpt == null || rispostagpt == ""){
                ...
                writeTxt(applicationContext, percorsoDeiFile)
                readTxtNormale(applicationContext, percorsoDeiFile)
            }else{
                fileContentss = "\n\nGpt:{" + rispostagpt + "}finetesto\n\n"
                writeTxt(applicationContext, percorsoDeiFile)
                readTxtNormale(applicationContext, percorsoDeiFile)
    ...
    fun createAndWriteToFile(context: Context, percorsoCartella: String) {
        ...
        try {
            ...
            Log.d("CHAT", "Directory del file: " + Folder)

            //println("Contenuto del file: $readContent")
        } catch (e: IOException) {
            Log.d("CHAT","Si è verificato un errore durante la creazione o la lettura del file.")
            e.printStackTrace()
        }

    }

    fun ReadTxt(context: Context, percorsoCartella: String) {
        val percorsoFolder = percorsoCartella
        val Folder = File(percorsoFolder)
        TextConv = findViewById(R.id.conversazioni)
        val filePath = Folder // Sostituisci con il percorso del tuo file
    ...
    fun writeTxt(context: Context, percorsoCartella: String){
        val percorsoFolder = percorsoCartella
        val Folder = File(percorsoFolder)
        val filePath = Folder
    ...
    fun readTxtNormale(context: Context, percorsoCartella: String){
        val percorsoFolder = percorsoCartella
        val Folder = File(percorsoFolder)
        val filePath = Folder
